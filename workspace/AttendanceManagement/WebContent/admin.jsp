	...
	<div>
		...
		<html:form action="/EmployeeAdd" method="POST">
			...
			<table id="table_1">
				...
				<tr>
					<td>社 員 番 号：
					<td><input type="text" name="empNum" maxlength="4"
						placeholder="010">
				<tr>
					<td colspan="2" height="5xp">
				<tr>
					<td>名 前：
					<td><input type="text" name="empName" maxlength="10"
						placeholder="滝本博昭">
				<tr>
					<td colspan="2" height="5xp">
				<tr>
					<td>パスワード ：
					<td><input type="text" name="empPass" maxlength="10"
						placeholder="0a1b2c3d4e">
			</table>
			<br>
			<h5>
				<bean:write name="AMForm" property="message2" />
			</h5>
			<br>
			<td width="50px">
				...
				<table id="table">
					<tr>
						<td><html:submit value="Submit" property="EmployeeAdd"
								styleId="button" />
						<td width="50px">
						<td><html:submit value="Delete" property="EmployeeDel"
					...
					<tr>
						<td width="50px">
						<td><html:button value="戻る" property="back"
								onclick="location.href='./login.jsp'" styleId="button" />
				</table>
		</html:form>
	</div>
</body>
