...
<BODY>
    ...
    <TABLE border="1">
        <TBODY>
            ...
            <!-- offset、length属性によるページ制御 -->
            <logic:iterate id="product" name="products" type="model.Product"
                offset="<%=(String) request.getAttribute(\"offset\")%>" length="10">
                <TR>
                    <TD><html:link action="/CatalogDetail" paramId="id"
    ...
    <html:form action="/CatalogPage">
        ...
        <logic:lessThan name="offset"
            value="<%=Integer.toString(((java.util.List<?>) session
        ...
        <html:hidden property="offset"
            value="<%=(String) request.getAttribute(\"offset\")%>" />
    </html:form>
</BODY>
</html:html>
